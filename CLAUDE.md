...
- 突進技快速鍵(07-16 三修):E=跳殺、R=飛殺直發(不需衝刺);衝刺 ≥0.35s 後按出手——遠距帶(5-12m)=跳殺(拋物線躍撲 airY,落地斬 1.6x)、近距帶(2-5m)=飛殺(1.8x 衝刺速爆發突進,接觸 1.8m 斬 1.5x);TECH_CD 3.5s 共用冷卻,玩家限定。
- 自動面向(07-16 三修):只在「站定/後退/沒按方向」時鎖定——按住 W 前進完全讓位(黏人真兇教訓);出手/大招瞬間攻距內直接轉身面對再判定(玩家限定輔助)。
...
- AI 全檔調弱 aiSpd 0.5-0.95+入門以下喘息腦(4-8s 停 1.4s);橫掃武器貼臂 π/2+YXZ(詳 arena-duel-kit 雷區)。
